...
cd ~ 
sudo rm -rf opencv*
git clone -b v4.10.0 --recursive --depth=1 https://github.com/opencv/opencv.git .opencv
git clone -b v4.10.0 --recursive --depth=1 https://github.com/opencv/opencv_contrib.git .opencv_contrib
